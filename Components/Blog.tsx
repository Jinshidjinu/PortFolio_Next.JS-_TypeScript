            ...
            <div className='w-[90%] text-center mx-auto bg-[#09101a] relative p-[2rem] mt-[-1rem]'> 
                ...
                <div className='flex flex-col md:flex-row items-center mt-[1rem] space-x-4 '>
                  <div className='flex items-center space-x-4'>
                   ...
                   <p className='text-white'>By Jinshid</p>
                  </div>
           ...
           <div>
            ...
            <div className='w-[90%] text-center mx-auto bg-[#09101a] relative p-[2rem] mt-[-1rem]'> 
                ...
                <div className='flex flex-col md:flex-row items-center mt-[1rem] space-x-4 '>
                  <div className='flex items-center space-x-4'>
                    <UserCircleIcon className='w-[2rem] mx-auto h-[1.5rem] text-[#55e6a5] '/>
                   <p className='text-white'>By Vaseem</p>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <ChatBubbleLeftIcon className='w-[2rem] mx-auto h-[2rem] text-[#55e6a5]'/>
                    <p className='text-white'>Comments(2)</p>
           ...
           <div>
            ...
            <div className='w-[90%] text-center mx-auto bg-[#09101a] relative p-[2rem] mt-[-1rem]'> 
                ...
                <div className='flex flex-col md:flex-row items-center mt-[1rem] space-x-4 '>
                  <div className='flex items-center space-x-4'>
                    <UserCircleIcon className='w-[2rem] mx-auto h-[1.5rem] text-[#55e6a5] '/>
                   <p className='text-white'>By Sinan</p>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <ChatBubbleLeftIcon className='w-[2rem] mx-auto h-[2rem] text-[#55e6a5]'/>
                    <p className='text-white'>Comments(2)</p>
